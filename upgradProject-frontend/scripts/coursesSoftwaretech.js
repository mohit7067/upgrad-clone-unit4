let st_url = `http://localhost:4900/softwaretech`

async function upgradtech(){

    try {
          let res= await fetch(st_url)
          let tech_arr= await res.json()
           console.log(`tech ${tech_arr}`)
           appendtech(tech_arr)
 ...
 function appendtech(tech_arr){
    var main =document.querySelector("#SoftwareTech")
   tech_arr.map(function(el){
